...
export default function DashboardPage() {
  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      if (isOffline) {
        // Use mock tasks for offline mode
  ...
  const handleSubmitReport = async () => {
    try {
      ...
      if (isOffline) {
        ...
        setNewReport({ title: '', content: '', week_ending: '' })
  ...
  const getTaskStats = () => {
    const assignedTasks = tasks.filter(task => task.type === 'assigned' && task.assigned_to === user?.id)
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              ...
              <Card className="border-2 border-black">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-semibold text-black font-['Work_Sans']">Weekly Team Standup</h4>
                      <p className="text-sm text-gray-600 font-['Work_Sans']">April 22, 2024 at 09:00 AM</p>
                      <p className="text-xs text-gray-500 font-['Work_Sans']">Conference Room A</p>
                    </div>
              ...
              <Card className="border-2 border-black">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-semibold text-black font-['Work_Sans']">Project Kickoff Meeting</h4>
                      <p className="text-sm text-gray-600 font-['Work_Sans']">April 25, 2024 at 02:00 PM</p>
                      <p className="text-xs text-gray-500 font-['Work_Sans']">Virtual Meeting</p>
                    </div>
                    <Button size="sm">
                      Join Meeting
                    </Button>
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              ...
              <Card className="border-2 border-black">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-semibold text-black font-['Work_Sans']">Innovation Workshop: AI in Business</h4>
                      <p className="text-sm text-gray-600 font-['Work_Sans']">April 28, 2024 at 10:00 AM</p>
                      <p className="text-xs text-gray-500 font-['Work_Sans']">Innovation Lab - Room 301</p>
                      <span className="inline-block mt-1 px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">Workshop</span>
                    </div>
                    <Button size="sm">
                      Register
                    </Button>
              ...
              <Card className="border-2 border-black">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-semibold text-black font-['Work_Sans']">Startup Pitch Competition</h4>
                      <p className="text-sm text-gray-600 font-['Work_Sans']">May 5, 2024 at 02:00 PM</p>
                      <p className="text-xs text-gray-500 font-['Work_Sans']">Main Auditorium</p>
                      <span className="inline-block mt-1 px-2 py-1 bg-red-100 text-red-800 text-xs rounded-full">Competition</span>
                    </div>
                    <Button size="sm">
                      Register
                    </Button>
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              ...
              <Card className="border-2 border-black">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-semibold text-black font-['Work_Sans']">Weekly Progress Report - Week 3</h4>
                      <p className="text-sm text-gray-600 font-['Work_Sans']">Submitted on April 15, 2024</p>
                      <span className="inline-block mt-1 px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">Approved</span>
                    </div>
                    <Button size="sm" variant="outline">
                      View Report
                    </Button>
              ...
              <Card className="border-2 border-black">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-semibold text-black font-['Work_Sans']">Weekly Progress Report - Week 2</h4>
                      <p className="text-sm text-gray-600 font-['Work_Sans']">Submitted on April 8, 2024</p>
                      <span className="inline-block mt-1 px-2 py-1 bg-yellow-100 text-yellow-800 text-xs rounded-full">Under Review</span>
                    </div>
                    <Button size="sm" variant="outline">
                      View Report
                    </Button>
