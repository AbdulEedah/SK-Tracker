...
6. **Bulk Operations**: Support bulk mark as read/delete
...
### 12. Bulk Delete Tasks (Admin Only)
**DELETE** `{{baseUrl}}/tasks/bulk-delete`
...
**DELETE** `{{baseUrl}}/notifications/bulk-delete`
...
### 9. Bulk Delete Files
**DELETE** `{{baseUrl}}/uploads/bulk-delete`
